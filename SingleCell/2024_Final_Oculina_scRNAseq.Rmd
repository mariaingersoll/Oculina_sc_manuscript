...
actually idk if the eggnog one was better -doing it with the GO_swiss_prot from the annotations (apoculata_GeneAnnotation_combined.txt) file NAH
```{r}
#BP
input="go_input_full2.csv"
