...
nfkb_perc_bin <- DimPlot(oc_diff_2, reduction = "umap", group.by = "NFKB_perc_bin", cols=c("grey80", "blue"), split.by = "symstate", shuffle=TRUE)
...
general_imm_bin <- DimPlot(oc_diff_3, reduction = "umap", group.by = "general_imm_bin", cols=c("grey80", "blue"), split.by = "symstate", shuffle=TRUE)
