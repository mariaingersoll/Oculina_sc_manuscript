...
```{r}
setwd("/projectnb/coral/MVI_Oculina/Oculina_sc_manuscript/16S")
```
...
```{r}
silva_path <- "/projectnb/davieslab/mingers/Oculina_16S_2022/Oculina_sc_manuscript/16S/silva/silva_nr99_v138.1_train_set.fa.gz" 
...
```{r}
silva_sp_path <- "/projectnb/davieslab/mingers/Oculina_16S_2022/Oculina_sc_manuscript/16S/silva/silva_species_assignment_v138.1.fa.gz"
...
pcoa_all #saved as relative_abundance_pca.pdf as 5x3 portrait
